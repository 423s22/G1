        ...
        <div className="home-page-content">
            <div className='flex' >
                ...
                <div className='hpc-main-pic'>
                    <img src={Hank} alt='Hank' style={{textAlign:'center', height: '100%', width: '100%'}}/> 
                </div>
            </div>
            <div className='break' style={{left: '100px', top: '900px'}}>
            </div>
            <div className='our-story'>
                <div>
                    <h1 style={{fontFamily: 'BebasNeue', padding: '10px', fontSize: '100px', textAlign: 'center'}}>OUR STORY</h1>
                ...
                <div style={{display:"flex"}}>
                    <img src={Hank} alt='Hank'  style={{textAlign:'center', display:'flex', padding:'50px', height: '100%', width: '100%'}}/> 
